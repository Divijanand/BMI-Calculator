...
public class BMI_CSC215_Metric_DivijAnand {
    private static final float WEIGHT_INCREMENT = 2.5f;
    ...
    public static void displayWelcomeMessage() {
        ...
        System.out.println("--            BODY MASS INDEX (BMI) COMPUTATION, CSC215, Metric Version ");
    ...
    public static void displayTable(float lowWeight, float highWeight, float height, float userWeight, float userBMI) {
    ...
    private static void printTableRow(float weight, float height, boolean isUserWeight, float lowWeight, float highWeight) {
        float bmi = getBMI(height, weight);
        String weightStatus = getWeightStatus(bmi);
